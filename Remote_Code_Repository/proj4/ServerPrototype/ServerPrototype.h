...
namespace Repository
{
  ...
  public:
	...
	//RepoCore<NoSqlDb::PayLoad> *repoCore;

	ServerProc wrappedLambda_Checkin();
	ServerProc wrappedLambda_closeCheckin();
	ServerProc wrappedLambda_Checkout();
	ServerProc wrappedLambda_displayCate();
	ServerProc wrappedLambda_query();
  ...
  private:
	...
	NoSqlDb::DbCore<NoSqlDb::PayLoad> db_;
	RepoCore<NoSqlDb::PayLoad> *repoCore;
	//RepoCore<NoSqlDb::PayLoad> *repoCore = new RepoCore<NoSqlDb::PayLoad>(db_);
  ...
  inline Server::Server(MsgPassingCommunication::EndPoint ep, const std::string& name)
    : comm_(ep, name) {
    initializeDb();
	repoCore = new RepoCore<NoSqlDb::PayLoad>(db_);
	//RepoCore<NoSqlDb::PayLoad> repoCore = RepoCore<NoSqlDb::PayLoad>(db_);
  }
